(function() {
    'use strict';
    angular.module('screenSizeTeller', [])
        .value('screenSizeResponsiveConfig', {
            sizes: [{
                name: 'tiny',
                minWidth: 0
            }, {
        ...
        .factory('screenSizeTeller', ['$window', '$filter', '$rootScope', 'screenSizeResponsiveConfig',
            function($window, $filter, $rootScope, screenSizeResponsiveConfig) {


                var opRegEx = /[<>]=?\s\w+/,
                    forEach = angular.forEach,
                    filter = angular.filter,
                    sizes = screenSizeResponsiveConfig.sizes;
